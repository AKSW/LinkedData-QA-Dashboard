...
class NamespaceStats {
	private Map<Node, Map<String, Map<String, Integer>>> propertyToSourceToTargetToCount;
...
public class LinkAnalyser {
	...
	public void createNamespaceStats(Iterator<Triple> itTriple) {
	...
	public void checkReverseLinks(NamespaceStats stats) {
